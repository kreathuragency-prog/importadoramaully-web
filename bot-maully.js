...
(function () {
  ...
  var KB = [
    ...
    },
    {
      ...
      answer: 'Un <b>gancho</b> es un fardo de menor exclusividad que se compra <b>junto a</b> un fardo top muy demandado.<br><br>📦 <b>Ejemplo:</b> si te llevas un <i>JORDAN 25 kg</i> (top exclusivo), debes sumar 2 ganchos en la misma compra.<br><br>🎯 <b>¿Por qué?</b><br>• Nosotros <b>rotamos bodega</b> de variedad de productos<br>• Tú <b>accedes a los fardos top</b> que no se venden sueltos<br>• Pagas <b>menos por kilo total</b> al combinar exclusivos + ganchos<br><br>🪝 <b>¿Qué fardos sirven como gancho?</b><br>Los ganchos <b>NUNCA son fardos premium ni marca</b>. Solo califican:<br>• <b>SEGUNDA</b> (sola)<br>• <b>MARCA SEGUNDA</b> o <b>PREMIUM SEGUNDA</b> (combos)<br>• Fardos cuyo título <b>NO contiene</b> "marca" ni "premium"<br><br>👉 Ver todos los <a href="/?cat=ganchos" onclick="event.preventDefault();filterByCategory(\'ganchos\');document.getElementById(\'productos\')?.scrollIntoView({behavior:\'smooth\'})"><b>fardos disponibles como gancho</b></a> en el catálogo.'
    },
    {
      id: 'marcas',
  ...
  '.mly-bot-foot{font-size:11px;color:#6b7280;text-align:center;padding:7px 10px;background:#f7f7fb;border-top:1px solid #e5e7eb}'+
  '.mly-bot-foot b{color:#e94560}'+
  ...
  panel.innerHTML =
    ...
    '</form>'+
    '<div class="mly-bot-foot">¿No encuentras lo que buscas? Te paso con <b>Bea</b> por WhatsApp</div>';

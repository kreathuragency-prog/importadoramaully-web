...
(function () {
  ...
  var KB = [
    ...
    {
      id: 'argentina',
      kw: ['argentina', 'mendoza', 'buenos aires', 'cordoba', 'argentino', 'rosario', 'tucuman', 'tucumán', 'salta', 'cruzar frontera', 'global66', 'global 66', 'precio argentina', 'envio argentina', 'envío argentina', 'puesto en argentina', 'puestos en argentina', 'al exterior', 'exportar', 'usd', 'dolares', 'dólares', 'dolar', 'dólar'],
      title: '¿Envían a Argentina? ¿Cuánto cuesta?',
      answer: '🇦🇷 Sí, enviamos a <b>Argentina</b> hace años — Mendoza, Córdoba, Buenos Aires y más.<br><br>📕 <b>Aquí tienes los 3 catálogos PDF</b>:<br>• <a href="https://importadoramaully.cl/catalogo-maully-marcas-exclusivas-argentina.pdf" target="_blank" rel="noopener"><b>👑 Marcas Exclusivas Argentina</b></a> — solo marcas premium (Columbia, Nike, Jordan, Realtree, etc.)<br>• <a href="https://importadoramaully.cl/catalogo-maully-argentina-mayo-2026.pdf" target="_blank" rel="noopener"><b>Catálogo Argentina completo</b></a> — los 34 productos puestos en Argentina<br>• <a href="https://importadoramaully.cl/catalogo-maully-mayo-2026.pdf" target="_blank" rel="noopener"><b>Catálogo completo Maully</b></a> — todos los productos<br><br>📦 <b>Envío a Argentina</b>: solo con <b>empresas privadas</b> desde Chile (Starken no aplica para Argentina). Tarifa por fardo:<br>• <b>$100.000 CLP/fardo</b> si pides <b>10 fardos o más</b><br>• <b>$150.000 CLP/fardo</b> si pides <b>hasta 9 fardos</b><br><br>🪝 <b>Productos con gancho</b>: el precio publicado es solo del fardo top. El total = fardo top + fardo gancho (Chile) + envío de ambos. Bea arma la cotización exacta.<br><br>💳 Pago <b>100% adelantado</b> vía <b>Global66</b> o <b>USD</b>.'
    },
    {
      id: 'pago_arg',
